...
public class NoticeModel {
	...
	public String notice_list(HttpServletRequest request,HttpServletResponse respone) {
	...
	public String notice_insert(HttpServletRequest request,HttpServletResponse respone) {
		request.setAttribute("admin_jsp", "../notice/notice_insert.jsp");
		request.setAttribute("main_jsp", "../adminpage/admin_main.jsp");
		return "../main/main.jsp";
	}
	@RequestMapping("admin/notice_insert_ok.do")
	public String notice_insert_ok(HttpServletRequest request,HttpServletResponse respone) {
	...
	public String notice_detail(HttpServletRequest request,HttpServletResponse respone) {
	...
	@RequestMapping("admin/notice_user_detail.do")
	public String notice_user_detail(HttpServletRequest request,HttpServletResponse respone) {
		String no=request.getParameter("no");
		// DB연동 
	...
	public String notice_user_list(HttpServletRequest request,HttpServletResponse respone) {
		   String page=request.getParameter("page");
		   if(page==null)
			   page="1";
	...
	public String notice_update(HttpServletRequest request,HttpServletResponse respone) {
		String no=request.getParameter("no");
		// DB연동 
		NoticeVO vo=NoticeDAO.noticeDetailData(Integer.parseInt(no), 0);
		request.setAttribute("vo", vo);
	...
	@RequestMapping("admin/notcie_update_ok.do")
	public String notice_update_ok(HttpServletRequest request,HttpServletResponse respone) {
		String type=request.getParameter("type");
		String subject=request.getParameter("subject");
		String content=request.getParameter("content");
		String no=request.getParameter("no");
	...
	public String notice_delete(HttpServletRequest request,HttpServletResponse respone) {
		//  목록으로 돌아간다
		String[] no=request.getParameterValues("dbox");
		for(String no:nos) {
			NoticeDAO.
		}
		return "redirect:../admin/notice_list.do";
