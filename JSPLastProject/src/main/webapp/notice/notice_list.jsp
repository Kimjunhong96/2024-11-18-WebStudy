...
<form method=post action="../admin/notice_delete.do">
 <table class="table">
              <tr>
               <td>
                <a href="../admin/notice_insert.do" class="btn btn-outline-danger btn-sm">새글</a>
               </td>
              </tr>
             </table>
             <table class="table" style="height: 500px">
              ...
              <c:forEach var="vo" items="${list }">
                <tr>
                 <td width=10% class="text-center"><input type="checkbox" name="dbox" value="${vo.no }">
                 ${vo.no }</td>
                 <td width=40%><a href="../admin/notice_detail.do?no=${vo.no}">[${vo.types}]&nbsp;${vo.subject }</td>
             ...
             <table class="table">
               <tr>
                ...
                <td class="text-right">
                 <a href="../admins/notice_list.do?page=${curpage>1?curpage-1:curpage }" class="btn btn-info btn-sm">이전</a>
