...
<body>
    ...
    <section class="archive-area section_padding_80">
        <div class="container">
            ...
            <table class="talbe">
            <tr>
              <td widthi="40%" class="table-danger" height="500">
               <table class="table">
                 <caption><h4 class=text-center>맛집정보</h4></caption>
               </table>
              </td>
              <td widthi="40%" class="table-info" height="400">
               <table class="table">
                 <caption><h4 class=text-center>예약일 정보</h4></caption>
               </table>
              </td>
              <td widthi="30%" class="table-success" height="700">
               <table class="table">
              ...
              <tr>
              <td widthi="30%" class="table-primary" height="200">
               <table class="table">
